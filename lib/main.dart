...
class _TelaPrincipalState extends State<TelaPrincipal> {
  ...
  void _exibirResultado() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => TelaResultado(tmb: _tmb)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Calculadora TMB')),
      body: Padding(
